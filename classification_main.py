...
parser.add_argument('--classification_model', type=str, default='ResNet18', choices=['VGG19', 'ResNet18', 'ResNet50', 'ResNet101'])
...
parser.add_argument('--target_data', type=str, default='AE_z16_type1')
